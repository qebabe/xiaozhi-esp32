...
python3 -m esptool --chip esp32s3 merge_bin -o merged-xiaozhi-firmware-0.4.bin --flash_mode dio --flash_freq 80m --flash_size 16MB 0x0000 bootloader/bootloader.bin 0x8000 partition_table/partition-table.bin 0xd000 ota_data_initial.bin 0x20000 xiaozhi.bin 0x800000 generated_assets.bin
